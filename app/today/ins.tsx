...
import { fetchTodayInsList } from "@/services/reservations";
...
export default function InsList() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["InsList"],
        queryFn: () => {
            return fetchTodayInsList({ dateIn: currentDate });
        },
        refetchOnMount: true,
    ...
    return (
        <View className="flex h-full w-full items-center justify-center bg-yellow-400 pt-32 pb-14 px-6">
            <Text className="mb-8 text-3xl text-gray-900 font-semibold">Ingresos de Hoy</Text>
                    ...
                    <View className="min-w-[300px]">
                        <DataTable>
                            {isLoading ? (
                                ...
                                <View className="flex h-full w-full justify-center items-center">
                                    <Text className="text-lg text-gray-900 font-semibold">No hay Ingresos Hoy</Text>
                                </View>
                            )}
